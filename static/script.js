...
function toggleNotifications() {
    // Placeholder for notification toggle functionality
    alert('Notifications feature coming soon!');
}

function openModal(title, platform, genre, quantity, price, image, buyUrl, rateUrl, canBuy, gameId, editUrl) {
